...
namespace OneKeyTools
{
    public partial class Time_Count : Form
    {
        ...
        string jsqsz;
        private void Time_Count_Load(object sender, EventArgs e)
        {
            ...
            时间ToolStripMenuItem.Text = times;
        ...
        private void Time_Count_Resize(object sender, System.EventArgs e)
        {
            label1.Left = (this.ClientRectangle.Width - label1.Width) / 2;
            label1.Top = (this.ClientRectangle.Height - label1.Height) / 2;
        }

        private void Time_Count_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            Time_Count.ActiveForm.Close();
            Globals.Ribbons.Ribbon1.button26.Enabled = true;
        }

        private void 使用说明ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("1. 点“重新开始”重新开始计时" + Environment.NewLine + "2. 点击“切换显示格式”切换时间格式" + Environment.NewLine + "3. 在“设置时间”中输入终止时间（秒）并回车；在“设置提示”中修改文字和声音提示" + Environment.NewLine + "4. 点击“修改文字”和“修改背景”选择修改颜色或格式" + Environment.NewLine + "5. 单击窗体后，按上/下键可以降低/提高窗体透明度" + Environment.NewLine + "6. 点击“保存设置”，可保存除透明度与背景图片之外的所有设置" + Environment.NewLine + "7. 点击“恢复默认”恢复所有设置为默认" + Environment.NewLine + "8. 单击窗体后，按【ESC】或右键点击“关闭”退出");
        }

        string times = "60";
        private void 时间ToolStripMenuItem_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == System.Convert.ToChar(13))
            {
                int time = int.Parse(时间ToolStripMenuItem.Text.Trim());
                if (time > 0)
                {
                    e.Handled = true;
                    timer1.Enabled = false;
                    times = time.ToString();
                    MessageBox.Show("设置成功，左键单击时间开始计时");
                }
            }
        }
        ...
        private void 文字格式ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (this.fontDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                this.Time_Count_Resize(sender, e);
            }
        }
        ...
        private void 保存设置ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("已保存除透明度和背景图片之外的所有设置；" + Environment.NewLine + "本设置同样适用于“数字时钟”“倒计时”功能");
        }
        ...
        private void 声音设置ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string Location = "";
